...
namespace T1708E.Controllers
{
    public class MarksController : Controller
    {
        private readonly T1708EContext _context;

        public MarksController(T1708EContext context)
        {
            _context = context;
        }
        ...
        {
            var t1708EContext = _context.Mark.Include(m => m.Student);
            return View(await t1708EContext.ToListAsync());
        }
